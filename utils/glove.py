"""
IsoDiM - GloVe Word Embeddings
==============================
GloVe word embedding loader for text processing.
"""
...
class GloVe:
    ...
    Args:
        meta_root: Directory containing GloVe data files
        prefix: Prefix for data files (e.g., 'our_vab')
    """
    
    def __init__(self, meta_root: str, prefix: str):
    ...
    def _get_pos_ohot(self, pos: str) -> np.ndarray:
        """Get one-hot vector for POS tag."""
    ...
    def __getitem__(self, item: str):
        """
        Get word embedding and POS one-hot vector.
        
        Args:
            item: String in format "word/POS"
            
        Returns:
            Tuple of (word_embedding, pos_one_hot)
        """
        word, pos = item.split('/')
